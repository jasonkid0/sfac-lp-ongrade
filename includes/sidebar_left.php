...
<!-- ===============================================MAIN NAVBAR========================================== -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!-- <li>
        ...
        <li>
          <a href="../grade/grade_summary.php"><i class="fa fa-list"></i> <span>Summary of Grade</span></a>
        </li>
        
        <li>
          <a href="../dashboard/view_curri.php"><i class="fa fa-list"></i> <span>View Curri with Grades</span></a>
        </li>
      ...
      elseif($_SESSION['role'] == "Student"){
        ...
        <li>
          <a href="../grade/check_list_grade.php?stud_id='.$_SESSION['userid'].'"><i class="fa fa-book"></i> <span>Grade Summary</span></a>
        </li>
        
        <li>
          <a href="../view_curri/curri.php?stud_id='.$_SESSION['userid'].'"><i class="fa fa-book"></i> <span>View Curri with Grade</span></a>
        </li>
