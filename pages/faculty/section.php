...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
            ...
            <div class="row">
              ...
              ?>
                  ...
                  $que = mysqli_query(
                    $db,
                    "SELECT DISTINCT section, time, day, room, subj_desc  
  FROM tbl_schedules 
  ...
  AND semester = '$_SESSION[active_sem]'"
                  ...
                  <td>' . $row['room'] . '</td>
                  <td><center>
                    <a href="class_stud.php?code=' . $_GET['code'] . '&section=' . $row['section'] . '&class_desc='.$row['subj_desc'].'" class="btn btn-danger">Enter Grade | Enter Absences | Transfer Section</a>
                    <a href="../forms/rog.php?code=' . $_GET['code'] . '&section=' . $row['section'] . '&faculty_id=' . $_GET['faculty_id'] . '&class_desc='.$row['subj_desc'].'" class="btn btn-success">View ROG</a>
