...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
            ...
            <div class="row">
              ...
              while ($row1 = mysqli_fetch_array($quer)) { ?>
                            ...
                            <div>
                                <a href="../class/class_history.php?stud_id=<?php echo $_GET['faculty_id'] ?>" class="btn btn-primary">View Class History</a>
                            </div>
  ...
  GROUP BY class_code"
                  ...
                  <td><a href="section.php?code=' . $row1['class_code'] . '&faculty_id=' . $_GET['faculty_id'] . '&class_desc=' . $row1['subj_desc'] . '" class="btn btn-primary">View Class</a></td>
                </tr>';
                  }
