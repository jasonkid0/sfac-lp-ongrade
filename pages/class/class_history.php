...
$quer = mysqli_query($db,
  ...
  WHERE tbl_schedules.faculty_id = '$_GET[stud_id]' 
...
echo'
                  ...
                  <td><a href="section_history.php?code='.$row1['class_code'].'&desc='.$row1['subj_desc'].'&sem='.$sem.'&ay='.$schoolyear.'&stud_id='.$_GET['stud_id'].'" class="btn btn-info">View Class</a></td>
