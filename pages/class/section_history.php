...
<!-- ================================================./SIDEBAR LEFT============================================ -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Section(s) for <?php echo $_GET['code']; ?>
      
      (<?php echo $_GET['sem'] .', '. $_GET['ay']?>)
      ...
      <div class="row">
        ...
        where subj_code = '$_GET[code]' LIMIT 1");
              while ($row = mysqli_fetch_array($que)) {
                ?>
              <h2 class="box-title"><strong>Section(s) for <?php echo $_GET['code'].' - '.$row['subj_desc']; ?>
...
$que = mysqli_query($db,
  ...
  FROM tbl_schedules 
  WHERE tbl_schedules.faculty_id = '$faculty_id' 
...
while($row = mysqli_fetch_array($que)){
  echo'<tr>
                  ...
                  <td><center>
                    ...
                    <a href="class_stud.php?code='.$_GET['code'].'&section='.$row['section'].'&sem='.$_GET['sem'].'&ay='.$_GET['ay'].'" class="btn btn-danger">Enter Grade | Enter Absences | Transfer Section</a>
