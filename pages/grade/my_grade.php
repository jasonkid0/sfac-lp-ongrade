                ...
                <div class="col-sm-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h2 class="box-title">Hi <strong><?php echo $_SESSION['user'] ?></strong> this is your
                                Grade(s) for
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                      $id = $row['enrolled_subj_id']; ?>
                                    <tr>
                                        ...
                                        <td><?php echo  $row['subj_desc']; ?>
                                        </td>
                                        <td><?php echo  $row['absences']; ?>
                                        </td>
                                        <td><?php echo ($row['accounting_status'] == 'Paid') ? $row['prelim'] : ""; ?>
                                        </td>
                                        <td><?php echo ($row['accounting_status'] == 'Paid') ? $row['midterm'] : ""; ?>
                                        </td>
                                        <td><?php echo ($row['accounting_status'] == 'Paid') ? $row['finalterm'] : ""; ?>
                                        </td>
                                        <td><?php echo ($row['accounting_status'] == 'Paid') ? $row['ofgrade'] : ""; ?>
                                        </td>
                                        <td><?php echo ($row['accounting_status'] == 'Paid') ? $row['numgrade'] : ""; ?>
                                        </td>

                                        <?php if ($row['remarks'] == 'Failed' && $row['accounting_status'] == 'Paid') {
                          echo '<td style="background-color: red"> ' . $row['remarks'] . '</td>';
                        } elseif ($row['remarks'] == 'INC' && $row['accounting_status'] == 'Paid') {
                          echo '<td style="background-color: yellow"> ' . $row['remarks'] . '</td>';
                        } elseif ($row['remarks'] == 'Passed' && $row['accounting_status'] == 'Paid') {
