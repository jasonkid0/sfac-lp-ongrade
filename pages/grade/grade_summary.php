...
<!-- ================================================./SIDEBAR LEFT============================================ -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>View Student's Summary Grade</h1>
    </section>
    ...
    <section class="content">
      <!-- Main row -->
                    ...
                    <select name="name" id="name" data-style="btn btn-primary btn-round" required class="form-control select-2">
                      <option selected disabled>Student Name</option>
                              <?php 
                                ...
                                $q1 = mysqli_query($db,"
                                    SELECT DISTINCT tbl_schoolyears.stud_id, CONCAT(tbl_students.lastname, ' ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname 
          ...
          while ($row = mysqli_fetch_array($que))
              echo'<script>{
                location.replace("check_list_grade.php?stud_id='.$_SESSION['userid'].'")}
                  </script>';
